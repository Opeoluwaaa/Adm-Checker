...
let admission_check = function check() {
    ...
    selectedgrades = (function getSelectedGrade () {
        ...
        // if ( waec_grades.includes('Grade')) {

        //     let wmessage = " Unfortunately, your admission can not be processeed simply because of your Olevel result input. Kindly check your inputs to see if they are all correct.";

        //     document.getElementById('status').innerHTML = wmessage;
        //     console.log('hello')
        // }
    ...
    check = (function () {
        ...
        let sitmessage = " Unfortunately, your admission can not be processeed simply because of your number of sitting. Kindly check your input for number of sitting as we only process applicants with a maximum of 2 sittings. Thanks for your understanding.";
        ...
        let message5 = "Unfortunately, you are unable to meet the admission's cut off mark as your Overall Percentage Score falls below 60%";
        ...
        } else if (utme_percent > 50 || utme_percent <= 0) {
            
            document.getElementById('status').innerHTML = jmessage;
            
        }  else if (putme_percent > 20 || putme_percent <= 0) {
            
            document.getElementById('status').innerHTML = pmessage;

        } else if (numsit > 2 || numsit <= 0) {
